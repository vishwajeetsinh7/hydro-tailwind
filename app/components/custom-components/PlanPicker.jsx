...
const PlanPicker = () => {
  ...
  return (
    ...
    <div className="plan-picker">
      <h1 className="title font-roboto_bold font-[700]">Get your meats now</h1>
      <p className=" description italic font-roboto_medium text-[20px]">
      ...
      <div className="sfq-wrapper">
        <div className="sfq">
          ...
          <div className="text-[22px] font-roboto_bold text-[#1d1d1d] uppercase border-b-4 border-[#425b34]">
          <h3 className="">Select Your <br /> Frequency</h3>
          </div>
        </div>
